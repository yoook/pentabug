...
#define MLDY_OCTSHIFT_UP 	0xfffc // shift the octave up
#define MLDY_OCTSHIFT_DOWN	0xffeb // shift the octave down
...
void play_melody(uint16_t melody[], size_t len, uint8_t octave, uint16_t speed);
